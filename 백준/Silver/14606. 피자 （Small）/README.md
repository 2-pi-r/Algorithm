...
### 출력 
 ...
 ### 내 풀이 (힌트)
 <p> 피자탑 나누는 방법 여러 가지, 겹침 --> dp </p>
 <p> dp 1. 중복 부분문제 저장 2. 최적 부분구조 </p>
 <p> curr : 높이n 피자판 분리하면서 얻은 "즐거움 총합의 최댓값" </p>
<p> d(n) = k*(n - k)+ d(k) + d(n - k)	(k = 1 ~ n/2 ) </p>

###### ex) 3 (0) / 1 2 (2) / 1 1 1 (3)
###### ex) 5 (0) / 2 3 (6) / (기존즐거움6 + 2쪼개기 + 3쪼개기)
###### ex) 6 (0) / 3 3 (9) / (9+3)
######          or 2 4 (8) / 
######          or 1 5 (5) / (5+10)
